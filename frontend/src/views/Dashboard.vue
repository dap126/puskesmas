      ...
      <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
          <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
            <div
              class="flex items-center px-5 py-6 bg-gray-50 border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition"
            >
        ...
        <div class="mt-8 flex flex-wrap -mx-6">
          ...
          <div class="w-full px-6 mb-6 lg:w-1/3">
            <div class="bg-gray-50 border border-gray-100 rounded-2xl shadow-sm p-6">
              <h4 class="text-lg font-bold text-gray-800 mb-4 text-center border-b border-gray-200 pb-2">
