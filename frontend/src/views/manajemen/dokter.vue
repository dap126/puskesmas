    ...
    <div class="w-full bg-white p-6 border rounded-lg shadow-md">
              ...
              <tr v-for="(doc, index) in paginatedData" :key="doc.id_dokter" class="hover:bg-indigo-50/50 transition border-b border-gray-50 last:border-0">
                ...
                <td class="px-5 py-4 align-middle">
                  <div class="flex justify-center gap-2">
                    ...
                    <button class="bg-red-500 text-white p-1.5 rounded hover:bg-red-600 shadow-sm transition" title="Hapus Dokter" @click="openConfirmDialog(doc.id_dokter)">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
      ...
      <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
        <div class="bg-white p-7 rounded-2xl shadow-2xl w-full max-w-xl">
          ...
          <form class="grid grid-cols-2 gap-5" @submit.prevent="handleSubmitDokter">
