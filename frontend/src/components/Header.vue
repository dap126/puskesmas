...
<template>
  ...
  >
    ...
    <div class="flex items-center">
      ...
      <div class="relative">
        <button
          class="relative z-10 flex items-center justify-center w-8 h-8 overflow-hidden bg-gray-100 text-gray-600 rounded-full shadow border border-gray-200 hover:bg-gray-200 focus:outline-none transition-colors"
