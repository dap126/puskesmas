...
<template>
  <div class="flex">
    ...
    <button v-if="!isOpen" type="button" class="fixed top-4 left-4 z-30 p-2 text-gray-500 bg-white rounded-md shadow-sm lg:hidden focus:outline-none" @click="isOpen = true">
    ...
    <aside
      ...
      class="inset-y-0 left-0 z-50 flex flex-col h-screen bg-white border-r border-gray-200 transition-all duration-300 transform shadow-sm lg:translate-x-0 lg:static fixed"
    >
      <!-- Header Area -->
      <div class="flex items-center justify-between p-4 border-b border-gray-100 min-h-[64px]">
        <h3 v-if="!isMinimized" class="text-xl font-bold text-gray-800 tracking-tight whitespace-nowrap overflow-hidden transition-all">
          Puskesmas
        </h3>

        <!-- Toggle Button for Desktop -->
        <div class="hidden lg:block ml-auto">
          <button type="button" class="p-1.5 text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900 focus:outline-none transition-colors" title="Toggle Sidebar" @click="toggleMinimize">
        ...
        <div class="block lg:hidden ml-auto">
          <button type="button" class="p-1.5 text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900 focus:outline-none transition-colors" @click="isOpen = false">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
      ...
      <div class="flex-1 px-3 py-4 space-y-1 overflow-y-auto overflow-x-visible custom-scrollbar">
        <ul class="space-y-1">
          ...
          <li class="relative group">
            ...
            <ul v-if="isMinimized" class="absolute left-full top-0 ml-1 mt-0 bg-white border border-gray-200 shadow-xl rounded-md py-2 w-48 invisible group-hover:visible z-50 opacity-0 group-hover:opacity-100 transition-all">
              ...
              <li>
                <router-link to="/riwayat-medis" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Riwayat Medis
                </router-link>
              </li>
            </ul>
          ...
          <li class="relative group">
            ...
            <ul v-if="isMinimized" class="absolute left-full top-0 ml-1 mt-0 bg-white border border-gray-200 shadow-xl rounded-md py-2 w-48 invisible group-hover:visible z-50 opacity-0 group-hover:opacity-100 transition-all">
              ...
              <li>
                <router-link to="/resep" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Antrean Resep
                </router-link>
              </li>
              <li>
                <router-link to="/daftar-obat" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Daftar Obat
                </router-link>
              </li>
            </ul>
          ...
          <li class="relative group">
            ...
            <ul v-if="isMinimized" class="absolute left-full top-0 ml-1 mt-0 bg-white border border-gray-200 shadow-xl rounded-md py-2 w-48 invisible group-hover:visible z-50 opacity-0 group-hover:opacity-100 transition-all">
              ...
              <li>
                <router-link to="/data-dokter" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Data Dokter
                </router-link>
              </li>
              <li>
                <router-link to="/jadwal" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Jadwal Poliklinik
                </router-link>
              </li>
            </ul>
        ...
        <ul class="space-y-1">
          ...
          <!-- MANAJEMEN (Dropdown) -->
          <li v-if="userRole === 'admin'" class="relative group">
            <button
            ...
            <ul v-if="!isMinimized && openMenus.manajemen" class="mt-1 space-y-1 px-2 pt-1 border-l-2 border-gray-100 ml-3">
              ...
              <li>
                <router-link to="/manajemen/pasien" :class="route.name === 'Manajemen-pasien-page' ? 'text-blue-600 font-medium' : 'text-gray-500 hover:text-gray-900'" class="flex items-center py-2 px-3 rounded-md text-sm transition-colors">
                  Kelola Pasien
                </router-link>
              </li>
            </ul>
            ...
            <ul v-if="isMinimized" class="absolute left-full top-0 ml-1 mt-0 bg-white border border-gray-200 shadow-xl rounded-md py-2 w-48 invisible group-hover:visible z-50 opacity-0 group-hover:opacity-100 transition-all">
              ...
              <li>
                <router-link to="/manajemen/user" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Kelola User
                </router-link>
              </li>
              <li>
                <router-link to="/manajemen/dokter" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Kelola Dokter
                </router-link>
              </li>
              <li>
                <router-link to="/manajemen/pasien" class="flex px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600">
                  Kelola Pasien
                </router-link>
              </li>
            </ul>
